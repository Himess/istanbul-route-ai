...
export const CONTRACT_ADDRESS =
  (process.env.NEXT_PUBLIC_CONTRACT_ADDRESS || "0xD117bDB3d1463a1B47561eb74BEa88ebE93B81CF").trim();
...
export const PARKING_CONTRACT_ADDRESS =
  (process.env.NEXT_PUBLIC_PARKING_CONTRACT_ADDRESS || "0x198be13482770fa01e36ae199f8e6873ad2f7b91").trim();
