...
import "../src/IstanbulRouteX402.sol";
...
contract Deploy is Script {
    function run() external {
        ...
        IstanbulRouteX402 cityPulse = new IstanbulRouteX402(queryPrice);

        console.log("IstanbulRouteX402 deployed at:", address(cityPulse));
