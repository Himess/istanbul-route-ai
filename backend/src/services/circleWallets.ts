...
const walletStore = new Map<string, IstanbulRouteWallet>();
...
class CircleWalletService {
  ...
  async createWallet(sessionId?: string): Promise<{
    ...
    try {
      ...
      const wallet: IstanbulRouteWallet = {
        id: rawWallet.id,
   ...
   */
  getWalletBySession(sessionId: string): IstanbulRouteWallet | null {
   ...
   */
  getAllSessions(): Array<{ sessionId: string; wallet: IstanbulRouteWallet }> {
    const result: Array<{ sessionId: string; wallet: IstanbulRouteWallet }> = [];
